'''
Unit testing script for ValidProt c2.
'''
...
class TestSample(unittest.TestCase):
    ''' 
    Tests for the validprot_sample function.
    '''
    ...
    def test_smoke(self):
        ...
        '''
        assert c2.validprot_sample(get_clean_df('learn2therm_sample_50k.zip').sample(100), 
    ...
    def test_oneshot_random(self):
        ...
        df, idx = c2.validprot_sample(test_df, size = 10, stat_samp = 'random')
    ...
    def test_oneshot_FW(self):
        ...
        '''
        test_df = get_clean_df('learn2therm_sample_50k.zip').sample(100).reset_index()
        df, idx = c2.validprot_sample(test_df, size = 10, stat_samp = 'frankwolfe')
    ...
    def test_correct_input(self):
        '''
        Test that only ValidProt data can pass through function.
        '''
        
        test_df = pd.DataFrame({'a':[1,2,3], 'b':[4,5,6]})
        
        with self.assertRaises(AttributeError):
            c2.validprot_sample(test_df, size = 10)
