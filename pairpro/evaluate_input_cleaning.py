...
#consider using only this funciton to speed up code
    ...
    """
    NOTE FOR BELOW:
    This cleaning function does not contain any cleaning for iFeature stuff.
    This is because there is a cleaning function in iFeature script.
    First, we will confirm this works, and then see if iFeature cleaning can
    be integrated into the function below.
    """
